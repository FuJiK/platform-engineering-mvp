# EDN 1 ファイルから Terraform と MCP を生やす Platform Engineering MVP を作った話

> 公開前ドラフト — [platform-engineering-mvp](https://github.com/FuJiK/platform-engineering-mvp) の内容をブログ向けにまとめたもの。  
> 最終更新: 2026-08-17 / Phase 1 完了時点
...
- [x] EDN から Terraform JSON / ops-policy を生成
- [x] Terraform で nginx コンテナをプロビジョニング
- [x] MCP Server がロール別にツール公開
- [x] 危険操作がツールとして存在しない
